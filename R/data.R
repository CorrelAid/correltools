...
#' \describe{
#'   \item{chapter_de}{chapter name in German (cf. navbar on \url{https://correlaid.org/de})}
#'   \item{chapter_en}{chapter name in English (cf. navbar on \url{https://correlaid.org})}
