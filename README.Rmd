...
The default username will be {first name}{first letter of last name}, e.g. "LeoM". 
If you want to override this behaviour, you can specify the `user_id` argument:
